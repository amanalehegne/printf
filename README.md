...
This simple printf function is built by Amanuel Alehegne Wubete and Nahom Getachew Gari.

# Welcome

Rebuild of the standard printf function in C. Our project required a function capable of printing with the %d, %c, %s, and %% specifiers to standard output. 
